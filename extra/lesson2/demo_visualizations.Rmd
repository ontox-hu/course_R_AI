---
title: "Demo - Visualizations with R"
subtitle: "Introduction into R for Reproducible Research and Machine Learning"
...
https://rstudio-connect.hu.nl/demo-ggplot2/
...
## ggplot2
The ggplot2 package in R is the best plotting system for R. It's syntax is an implementation of the 'grammar of graphics' and all plots in this demo are created by using the `{ggplot2}` R package.
...
gapminder %>% 
  ...
  ggplot(aes(x = year,
             y = infant_mortality)) +
  geom_point(aes(colour = country), position = "jitter", show.legend = FALSE) 
